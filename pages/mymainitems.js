      ...
      <div className="container dwi-div dwi-card">
        ...
        <div className="row">
          ...
          <div className="card-deck">
            <div className="card col-6 cardmin margintopbottom dwi-form-section">
              ...
              <strong>{mymainitems.name} </strong>  +  BONUS Bottles & Glasses <strong> JUST   ${mymainitems.salePrice} </strong>  {mymainitems.numberOfBottles} Bottles 
                <Link href="/zipdeals"> 
